...
if space_charge_flag:
        ...
        if transverse_plane == 'H': 
                parameters['input_distn'] = '../../01_Generate_Initial_Distribution_BLonD/1_H_21/bunch_output/mainbunch_-000001.mat'
        else:
                parameters['input_distn'] = '../../01_Generate_Initial_Distribution_BLonD/1_V_24/bunch_output/mainbunch_-000001.mat'
else:
        switches['Space_Charge'] = False
        if transverse_plane == 'H': 
                parameters['input_distn'] = '../../01_Generate_Initial_Distribution_BLonD/0_H_21/bunch_output/mainbunch_-000001.mat'
        else:
                parameters['input_distn'] = '../../01_Generate_Initial_Distribution_BLonD/0_V_24/bunch_output/mainbunch_-000001.mat'
