...
# Note this method uses a maximum D_x mismatch to leave D_xp unchanged
def find_dispersion_mismatch(D_0, Beta_0, M_D=0.35, verbose=True):
    ...
    if verbose:
        print 'find_dispersion_mismatch:'
        print '\tTune = (6.',str(p['tunex'][-2:]),', 6',str(p['tuney'][-2:]), ')'
