#!/usr/bin/env python
# Python script to create a SLURM plotting script for PyORBIT
# 11 August 2020 Haroon Rafique CERN BE-ABP-HSI 
...
#	SETTINGS
#-----------------------------------------------------------------------  
script_name = "SLURM_plotting_script.sh"
...
jobname = '6P_' + str(transverse_plane) + '_' + str(scan_tune)
...
print 'SLURM plotting script creation finished'
