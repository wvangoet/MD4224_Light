...
# Space charge flag - horizontal/vertical scan - voltage
# e.g. 0_H_21p2
...
parameters['rf_voltage']		= 0.0212 # PyORBIT voltage is always constant - match in BLonD
...
if space_charge_flag:
        ...
        if transverse_plane == 'H': 
                parameters['input_distn'] = '../../01_Generate_Initial_Distribution/1_H_21/bunch_output/mainbunch_-000001.mat'
        else:
                parameters['input_distn'] = '../../01_Generate_Initial_Distribution/1_V_24/bunch_output/mainbunch_-000001.mat'
else:
        switches['Space_Charge'] = False
        if transverse_plane == 'H': 
                parameters['input_distn'] = '../../01_Generate_Initial_Distribution/0_H_21/bunch_output/mainbunch_-000001.mat'
        else:
                parameters['input_distn'] = '../../01_Generate_Initial_Distribution/0_V_24/bunch_output/mainbunch_-000001.mat'
