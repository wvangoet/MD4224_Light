...
Horizontal_Scan_NoSC = False    # Can't run without SC - no tune data
Vertical_Scan_NoSC = False      # Can't run without SC - no tune data
...
if Horizontal_Scan_NoSC:
	for loc in H_locations_NoSC:
		print '--------------------------------------------------------------------------------------------'
		print '\t Submitting HPC-Batch plots: ', loc
		print '--------------------------------------------------------------------------------------------'
		dir_ = master_dir + loc
		make_command = 'python Make_SLURM_plotting_script.py'
		submit_command = 'sbatch SLURM_plotting_script.sh'
		os.chdir(dir_)
